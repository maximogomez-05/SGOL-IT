...
class Equipo:
    ...
    def __init__(self, nro_serie, modelo, tipo, id_cliente, id_equipo=None):
    ...
    def registrar(self):
        ...
        try:
            sql = """INSERT INTO equipo 
                     (Numero_Serie, Marca_Modelo, Tipo_Dispositivo, Cliente_ID_Cliente) 
                     VALUES (%s, %s, %s, %s)"""
    ...
    def buscar_por_numero_serie(nro_serie):
        ...
        try:
            cursor.execute("SELECT ID_Equipo as id, Numero_Serie as nro_serie, Marca_Modelo as modelo, Tipo_Dispositivo as tipo, Cliente_ID_Cliente as id_cliente FROM equipo WHERE Numero_Serie = %s", (nro_serie,))
